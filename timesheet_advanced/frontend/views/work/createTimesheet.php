...
<div class="work-form">
    ...
    <?php foreach ($modelDetails as $i => $modelDetail) : ?>
        <div class="row work-detail work-detail-<?= $i ?>">
            ...
            <div class="col-md-2"><?= $form->field($modelDetail, "[$i]work_time" )->textInput(['placeholder' => 'Work time (hours)'])?></div>
            <div class="col-md-2"><?= $form->field($modelDetail, "[$i]comment" )->textInput(['placeholder' => 'Comment'])?></div>
