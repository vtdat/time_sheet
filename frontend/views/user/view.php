...
<div class="col-md-3 col-md-offset-2">
    <?php    if ($model->avatar) {
        echo Html::img('../uploads/' . $model->avatar, ['alt' => 'avatar', 'style' => 'width:80%; float: right; padding-top: 1.9em;',]);
    } else {
        echo Html::img('../uploads/default-avatar.png', ['alt' => 'avatar', 'style' => 'width:80%; float: right; padding-top: 1.9em;',]);
    }
    ?>
</div>
...
<div class="col-md-6">
    ...
    <div id="contentBox" style="margin:20px auto 0 auto; width:100%">
        ...
        <div id="column2" style="float:left; margin:0;">
            ...
            <p><?= Html::encode(isset($model->birthday) ? $formatter->asDate($model->birthday, 'long') : '') ?></p>
